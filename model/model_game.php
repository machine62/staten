<?php
class model_game extends abstract_model{
	
	protected $sClassRow='row_game';
	
	protected $sTable='game';
...
class row_game extends abstract_row{
	
	protected $sClassModel='model_game';
