<?php
class model_groups extends abstract_model{
	
	protected $sClassRow='row_groups';
	
	protected $sTable='groups';
...
class row_groups extends abstract_row{
	
	protected $sClassModel='model_groups';
