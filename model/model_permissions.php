<?php
class model_permissions extends abstract_model{
	
	protected $sClassRow='row_permissions';
...
class row_permissions extends abstract_row{
	
	protected $sClassModel='model_permissions';
