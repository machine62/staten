<?php
class model_groupsusers extends abstract_model{
	
	protected $sClassRow='row_groupsusers';
	
	protected $sTable='groupsusers';
...
class row_groupsusers extends abstract_row{
	
	protected $sClassModel='model_groupsusers';
