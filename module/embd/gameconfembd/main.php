<?php 
class module_embd_gameconfembd extends abstract_moduleembedded{
	
	public static $sModuleName='gameconfembd';
	...
	*/
	...
	public function _list($conf){
	
		$oView=new _view('embd/gameconfembd::list');
		$oView->conf= $conf;
		return $oView;
	}
