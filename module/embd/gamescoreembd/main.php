<?php 
class module_embd_gamescoreembd extends abstract_moduleembedded{
	
	public static $sModuleName='gamescoreembd';
	...
	*/
	...
	public function _voir($game){
	
		$oView=new _view('embd/gamescoreembd::voir');
		$oView->game=$game;
